...
path = r"C:\Users\robso\Desktop\openssl test\results1"
...
for folder in folders:
    ...
    hybrid= find_in_tuple(folder, all_hybrid_kems)
...
merge_keys = ['sig','pq','cl','delay','loss','mtu','idx']
merged_df = pd.merge(
    s_client_df,
    s_client_perf_df,
    on=merge_keys,
